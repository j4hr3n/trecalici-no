...
- Add the final favicon, approved social image and page-specific metadata. Add absolute canonical URLs and `sitemap.xml` with the six real HTTPS URLs once the domain is confirmed. Do not invent a domain.
